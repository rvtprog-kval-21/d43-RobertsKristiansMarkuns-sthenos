...
import static com.example.sthenos.R.drawable.straddleplanchepushups;

public class StraddlePlanchePushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(straddleplanchepushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Straddle planche push-ups (Level 90)");
        ...
        descText.setText("Get in a straddle planche and try to go as low as possible. The lower the harder, but better");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanchePushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StraddlePlanchePushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(StraddlePlanchePushUp.this, IndoorActivity.class);
                        Toast.makeText(StraddlePlanchePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(StraddlePlanchePushUp.this, OutdoorActivity.class);
                        Toast.makeText(StraddlePlanchePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(StraddlePlanchePushUp.this, MainActivity.class);
                        Toast.makeText(StraddlePlanchePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(StraddlePlanchePushUp.this, MobilityActivity.class);
                        Toast.makeText(StraddlePlanchePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(StraddlePlanchePushUp.this, Equipment.class);
                        Toast.makeText(StraddlePlanchePushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
