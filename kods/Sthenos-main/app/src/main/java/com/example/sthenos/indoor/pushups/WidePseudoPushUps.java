...
import static com.example.sthenos.R.drawable.widepseudopushups;

public class WidePseudoPushUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(widepseudopushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Wide pseudo push-ups (Level 45)");

        levelTag.setText("Advanced");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Triceps, Chest, Shoulders");

        descText.setText("These are pseudo push-ups only wider. The wider you go the harder");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WidePseudoPushUps.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WidePseudoPushUps.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WidePseudoPushUps.this, IndoorActivity.class);
                        Toast.makeText(WidePseudoPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WidePseudoPushUps.this, OutdoorActivity.class);
                        Toast.makeText(WidePseudoPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WidePseudoPushUps.this, MainActivity.class);
                        Toast.makeText(WidePseudoPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WidePseudoPushUps.this, MobilityActivity.class);
                        Toast.makeText(WidePseudoPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WidePseudoPushUps.this, Equipment.class);
                        Toast.makeText(WidePseudoPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
