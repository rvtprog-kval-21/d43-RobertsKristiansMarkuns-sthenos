...
import static com.example.sthenos.R.drawable.slowpushups;

public class SlowPushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(slowpushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Slow push-ups (Level 20)");
        ...
        descText.setText("This is a Regular push-up, but you have to do it slowly. The slower the more challenging");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SlowPushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SlowPushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(SlowPushUp.this, IndoorActivity.class);
                        Toast.makeText(SlowPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(SlowPushUp.this, OutdoorActivity.class);
                        Toast.makeText(SlowPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(SlowPushUp.this, MainActivity.class);
                        Toast.makeText(SlowPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(SlowPushUp.this, MobilityActivity.class);
                        Toast.makeText(SlowPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(SlowPushUp.this, Equipment.class);
                        Toast.makeText(SlowPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
