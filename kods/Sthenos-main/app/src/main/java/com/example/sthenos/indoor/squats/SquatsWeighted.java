...
import com.example.sthenos.indoor.jump.StarJumps;
import com.google.android.material.bottomnavigation.BottomNavigationView;

import static com.example.sthenos.R.drawable.star_jumps_exercise;
import static com.example.sthenos.R.drawable.weightedsquat;

public class SquatsWeighted extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(weightedsquat);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Weighted squat");

        levelTag.setText("Novice");
        levelTag.setBackground(Drawable.createFromPath("@drawable/gradient_cyangreen"));

        muscleGroupText.setText("Legs");

        descText.setText("When doing the weighted squat make sure to have a straight back and engage your entire body. " +
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SquatsWeighted.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SquatsWeighted.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(SquatsWeighted.this, IndoorActivity.class);
                        Toast.makeText(SquatsWeighted.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(SquatsWeighted.this, OutdoorActivity.class);
                        Toast.makeText(SquatsWeighted.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(SquatsWeighted.this, MainActivity.class);
                        Toast.makeText(SquatsWeighted.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(SquatsWeighted.this, MobilityActivity.class);
                        Toast.makeText(SquatsWeighted.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(SquatsWeighted.this, Equipment.class);
                        Toast.makeText(SquatsWeighted.this, item.getTitle(), Toast.LENGTH_SHORT).show();
