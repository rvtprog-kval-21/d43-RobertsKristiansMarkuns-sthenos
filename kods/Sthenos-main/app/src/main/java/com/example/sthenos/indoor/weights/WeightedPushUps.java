...
import static com.example.sthenos.R.drawable.weightedpushup;

public class WeightedPushUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(weightedpushup);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Weighted push-ups");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeightedPushUps.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeightedPushUps.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WeightedPushUps.this, IndoorActivity.class);
                        Toast.makeText(WeightedPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WeightedPushUps.this, OutdoorActivity.class);
                        Toast.makeText(WeightedPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WeightedPushUps.this, MainActivity.class);
                        Toast.makeText(WeightedPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WeightedPushUps.this, MobilityActivity.class);
                        Toast.makeText(WeightedPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WeightedPushUps.this, Equipment.class);
                        Toast.makeText(WeightedPushUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
