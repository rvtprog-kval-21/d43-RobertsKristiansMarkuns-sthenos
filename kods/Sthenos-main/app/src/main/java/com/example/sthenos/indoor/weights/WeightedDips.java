...
import static com.example.sthenos.R.drawable.weighteddips;

public class WeightedDips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(weighteddips);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Weighted dips");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeightedDips.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeightedDips.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WeightedDips.this, IndoorActivity.class);
                        Toast.makeText(WeightedDips.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WeightedDips.this, OutdoorActivity.class);
                        Toast.makeText(WeightedDips.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WeightedDips.this, MainActivity.class);
                        Toast.makeText(WeightedDips.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WeightedDips.this, MobilityActivity.class);
                        Toast.makeText(WeightedDips.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WeightedDips.this, Equipment.class);
                        Toast.makeText(WeightedDips.this, item.getTitle(), Toast.LENGTH_SHORT).show();
