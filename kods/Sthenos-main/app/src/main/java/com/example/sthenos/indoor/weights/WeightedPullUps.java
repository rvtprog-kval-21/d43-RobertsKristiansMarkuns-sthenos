...
import static com.example.sthenos.R.drawable.weightedpullups;

public class WeightedPullUps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(weightedpullups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Weighted pull-ups");
        ...
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WeightedPullUps.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeightedPullUps.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(WeightedPullUps.this, IndoorActivity.class);
                        Toast.makeText(WeightedPullUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(WeightedPullUps.this, OutdoorActivity.class);
                        Toast.makeText(WeightedPullUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(WeightedPullUps.this, MainActivity.class);
                        Toast.makeText(WeightedPullUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(WeightedPullUps.this, MobilityActivity.class);
                        Toast.makeText(WeightedPullUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(WeightedPullUps.this, Equipment.class);
                        Toast.makeText(WeightedPullUps.this, item.getTitle(), Toast.LENGTH_SHORT).show();
