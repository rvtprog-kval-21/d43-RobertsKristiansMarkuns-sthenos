...
import static com.example.sthenos.R.drawable.supermanpushups;

public class SupermanPushUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exerciseImage.setImageResource(supermanpushups);

        /*---------Setting TextView values--------------*/

        exerciseTitle.setText("Superman push-ups (Level 60)");
        ...
        descText.setText("Put your arms infront of you and be completly straight");

        /*---------Button onClickListener--------------*/
        repRandomizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SupermanPushUp.this, RepRangeRandomizer.class);
        ...
        stopWatch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SupermanPushUp.this, Stopwatch.class);
                startActivity(intent);
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.nav_indoor:
                        Intent indoor = new Intent(SupermanPushUp.this, IndoorActivity.class);
                        Toast.makeText(SupermanPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(indoor);
                        break;
                    case R.id.nav_outdoor:
                        Intent outdoor = new Intent(SupermanPushUp.this, OutdoorActivity.class);
                        Toast.makeText(SupermanPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(outdoor);
                        break;
                    case R.id.nav_home:
                        Intent home = new Intent(SupermanPushUp.this, MainActivity.class);
                        Toast.makeText(SupermanPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(home);
                        break;
                    case R.id.nav_mobility:
                        Intent mobility = new Intent(SupermanPushUp.this, MobilityActivity.class);
                        Toast.makeText(SupermanPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
                        startActivity(mobility);
                        break;
                    case R.id.nav_equipment:
                        Intent equipment = new Intent(SupermanPushUp.this, Equipment.class);
                        Toast.makeText(SupermanPushUp.this, item.getTitle(), Toast.LENGTH_SHORT).show();
